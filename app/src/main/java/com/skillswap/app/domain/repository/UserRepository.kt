...
interface UserRepository {
    ...
    suspend fun updateLocation(userId: String, location: GeoPoint, neighborhood: String): Result<Unit>
    ...
    suspend fun getNearbyUsers(location: GeoPoint, radiusKm: Double): Result<List<User>>
}
